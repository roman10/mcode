import { COPILOT_ICON } from '@shared/constants';

/**
 * Renders an agent icon — SVG for Copilot (official GitHub Copilot icon from
 * Primer Octicons), plain text span for all other agents.
 */
